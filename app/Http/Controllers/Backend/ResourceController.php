...
class ResourceController extends Controller
{
    ...
    public function index(){
        ...
        return view('backend.pages.resource.index', compact('resources'));
    }
    ...
    public function store(Request $request){
        ...
        $resource->title_color = $request->title_color ?? '';
        $resource->details = $request->details ?? '';
        $resource->details_color = $request->details_color ?? '';
        $resource->button_text = $request->button_text ?? '';
        $resource->button_color = $request->button_color ?? '';
    ...
    public function edit($id){
        ...
        return view('backend.pages.resource.edit', compact('resource'));
    }

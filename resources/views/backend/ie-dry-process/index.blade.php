...
@section('title', 'Dry Process IE Management | ' . Helper::getSettings('application_name') ?? 'Machine Tool Solution')
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Dry Process IE Management</h4>
                ...
                <form method="GET" id="filter_form">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select class="form-control" name="plant" id="plantFilter">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select class="form-control" name="processType" id="processTypeFilter">
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Dry Process IE Data</h5>
                        </div>
                        <button type="button" class="btn btn-primary btn-create-dryprocess" data-toggle="modal"
                            data-target="#createModal">
                            <i class="fa-solid fa-plus"></i> Add Dry Process Data
                        </button>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.dryprocessie.get.list') }}",
                    type: 'GET',
                    data: function(d) {
                        d.date = $('#dateFilter').val();
                        d.plant = $('#plantFilter').val();
                        d.processType = $('#processTypeFilter').val();
            ...
            $('.btn-create-dryprocess').on('click', function() {
                $.ajax({
                    url: "{{ route('admin.dryprocessie.create.form') }}",
                    type: "GET",
            ...
            $(document).on('submit', '#createDryProcessForm', function(e) {
                e.preventDefault();
                let form = this;
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        $('#createDryProcessForm .server_side_error').html(
            ...
            $(document).on('click', '.edit_btn', function(e) {
                ...
                $.ajax({
                    url: "{{ url('admin/DryProcessIE/edit') }}/" + id,
                    type: "GET",
                    success: function(data) {
            ...
            $(document).on('submit', '#editDryProcessForm', function(e) {
                e.preventDefault();
                let form = this;
                ...
                var submitBtn = $('#updateDryProcessBtn');
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        $('#editDryProcessForm .server_side_error').html(
                            '<div class="alert alert-danger alert-dismissible fade show" role="alert">' +
                            errorMessage +
                            '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>' +
                            '</div>'
            ...
            function deleteDryProcess(id, table) {
                $.ajax({
                    url: "{{ url('admin/DryProcessIE/delete') }}/" + id,
                    type: "GET",
                    success: function(response) {
                        if (response.success) {
                            if (typeof $.toast === 'function') {

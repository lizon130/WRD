<div class="modal-header">
    <h5 class="modal-title" id="editModalLabel">
        <i class="fa-solid fa-pen-to-square"></i> Edit Dry Process IE Data
    </h5>
...
<div class="modal-body">
    <form method="POST" action="{{ route('admin.dryprocessie.update', $dryProcess->id) }}" id="editDryProcessForm"
        novalidate>
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-control @error('plant') is-invalid @enderror" name="plant" id="plant"
                    ...
                    @foreach ($plants as $plant)
                        <option value="{{ $plant }}" {{ $dryProcess->plant == $plant ? 'selected' : '' }}>
                            {{ $plant }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control @error('date') is-invalid @enderror" name="date"
                    id="date" value="{{ $dryProcess->date }}" required>
                ...
                <select class="form-control @error('processType') is-invalid @enderror" name="processType"
                    ...
                    @foreach ($processTypes as $processType)
                        <option value="{{ $processType }}"
                            {{ $dryProcess->processType == $processType ? 'selected' : '' }}>
                            {{ $processType }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" class="form-control @error('manPower') is-invalid @enderror" name="manPower"
                    id="manPower" value="{{ $dryProcess->manPower }}" placeholder="Enter number of workers"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" class="form-control @error('workingHr') is-invalid @enderror" name="workingHr"
                    id="workingHr" value="{{ $dryProcess->workingHr }}" placeholder="Enter working hours" min="0.5"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" class="form-control @error('smv') is-invalid @enderror" name="smv"
                    id="smv" value="{{ $dryProcess->smv }}" placeholder="Enter SMV value" min="0"
                    step="0.01" required>
        ...
        <div class="text-end mt-3">
            ...
            <button type="submit" class="btn btn-primary" id="updateDryProcessBtn">
...
<script>
    $(document).ready(function() {
        // Form validation
        $('#editDryProcessForm').on('submit', function(e) {

...
@section('title', 'Manpower Management | ' . Helper::getSettings('application_name') ?? 'Machine Tool Solution')
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Manpower Management</h4>
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Manpower Data</h5>
                        </div>
                        <button type="button" class="btn btn-primary btn-create-manpower" data-toggle="modal"
                            data-target="#createModal">
                            <i class="fa-solid fa-plus"></i> Add Manpower Data
                        </button>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-bordered" id="dataTable">
                    <thead>
                        <tr>
                            <th>Date</th>
                            <th>Unit</th>
                            <th>Direct Manpower</th>
                            <th>Indirect Manpower</th>
                            <th>Work Hours</th>
                            <th>SMV</th>
                            <th>Action</th>
                        </tr>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.manpower.get.list') }}",
                    type: 'GET',
                    data: function(d) {
            ...
            $('.btn-create-manpower').on('click', function() {
                $.ajax({
                    url: "{{ route('admin.manpower.create.form') }}",
                    type: "GET",
            ...
            // Create manpower form submission (using event delegation)
            $(document).on('submit', '#createManpowerForm', function(e) {
                e.preventDefault();
                let form = this;
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        $('#createManpowerForm .server_side_error').html(
            ...
            $(document).on('click', '.edit_btn', function(e) {
                ...
                $('#editModal .modal-content').html(`
                    ...
                    <div class="modal-body text-center">
                        ...
                        <p class="mt-2">Loading manpower data...</p>
                    </div>
                `);
                ...
                $.ajax({
                    url: "{{ url('admin/ManPower/edit') }}/" + id,
                    type: "GET",
                    success: function(data) {
            ...
            // Update manpower form submission (using event delegation)
            $(document).on('submit', '#editManpowerForm', function(e) {
                e.preventDefault();
                let form = this;
                ...
                var submitBtn = $('#updateManpowerBtn');
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        $('#editManpowerForm .server_side_error').html(
                            '<div class="alert alert-danger alert-dismissible fade show" role="alert">' +
                            errorMessage +
                            '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>' +
                            '</div>'
            ...
            function deleteManpower(id, table) {
                $.ajax({
                    url: "{{ url('admin/ManPower/delete') }}/" + id,
                    type: "GET",
                    success: function(response) {
                        if (response.success) {
                            if (typeof $.toast === 'function') {

...
@section('title', 'Second Dry Process Entry | ' . Helper::getSettings('application_name') ?? 'Machine Tool Solution')
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Second Dry Process Entry</h4>
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Second Dry Process Data</h5>
                        </div>
                        <button type="button" class="btn btn-primary btn-create-seconddryprocess" data-toggle="modal"
                            data-target="#createModal">
                            <i class="fa-solid fa-plus"></i> Add Second Dry Process Data
                        </button>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.second-dry-process.get.list') }}",
                    type: 'GET',
                    data: function(d) {
            ...
            $('.btn-create-seconddryprocess').on('click', function() {
                $.ajax({
                    url: "{{ route('admin.second-dry-process.create.form') }}",
                    type: "GET",
            ...
            $(document).on('click', '.edit_btn', function(e) {
                ...
                $.ajax({
                    url: "{{ url('admin/second-dry-process/edit') }}/" + id,
                    type: "GET",
                    success: function(data) {
            ...
            $(document).on('click', '.delete_btn', function(e) {
                ...
                if (confirm('Are you sure you want to delete this record?')) {
                    $.ajax({
                        url: "{{ url('admin/second-dry-process/delete') }}/" + id,
                        type: "GET",

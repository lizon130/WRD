        ...
        <div class="modal-content">
            <form id="createUserForm" action="{{ route('admin.user.store') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group  row">
                        <label for="" class="col-sm-2 col-form-label">Image<span class="text-danger">*</span></label>
                        <div class="col-sm-10">
                            <input type="file" class="form-control" onchange="previewFile('createModal #news_image', 'createModal .preview_image')" name="profile_image" id="profile_image" >

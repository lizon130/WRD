<form id="editUserForm" action="{{ route('admin.user.update', $user->id)}}" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="form-group  row">
            ...
            <div class="col-sm-9">
                <input type="file" class="form-control" onchange="previewFile('editModal #news_image', 'editModal .preview_image')" name="profile_image" id="profile_image" >
                <img src="{{ ($user->profile_image) ? asset('uploads/user-images/'.$user->profile_image) :  asset('assets/img/no-img.jpg')}}" height="80px" width="100px" class="preview_image mt-1 border" alt="">
            </div>
        </div>
        ...
        {{-- <div class="form-group  row">
            ...
            <div class="col-sm-10">
                <input type="password" name="password" class="form-control" placeholder="Password" vaiue={{ $user->password }}>
            </div>
        </div> --}}
    </div>

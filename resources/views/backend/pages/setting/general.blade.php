                ...
                <form action="{{ route('admin.setting.update') }}" id="settingForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group  row">
                        ...
                        <div class="col-sm-9" >
                            ...
                            <img src="{{ Helper::getSettings('site_logo') ? asset(Helper::getSettings('site_logo')) : asset('assets/img/no-img.jpg')}}" height="80px" width="100px" class="site_logo_image mt-1 border" alt="">
                        </div>
                    </div>
                    <div class="form-group  row">
                        ...
                        <div class="col-sm-9" >
                            ...
                            <img src="{{ Helper::getSettings('site_favicon') ? asset(Helper::getSettings('site_favicon')) : asset('assets/img/no-img.jpg')}}" height="80px" width="80px" class="site_favicon_image mt-1 border" alt="">
                        </div>
                    </div>
                    <div class="form-group row">

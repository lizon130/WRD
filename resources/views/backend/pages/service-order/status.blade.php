<form id="statusOrderForm" action="{{ route('admin.service.order.update.status', $order->id)}}" method="post" enctype="multipart/form-data">
    @csrf 
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Change Service Order Status</h5>

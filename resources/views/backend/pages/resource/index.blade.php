...
@section('title', 'Resource | '.Helper::getSettings('application_name') ?? 'Machine Tool Solution')
@section('content')
    ...
    @include('backend.pages.resource.modal')
    @push('footer')
        <script type="text/javascript">
            function getresource(code = null, title = null, status = null){
                var table = jQuery('#dataTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ url('admin/resource/get/list') }}",
                        type: 'GET',
                    },
                    aLengthMenu: [
            ...
            $(document).on('click', '.delete_btn', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{  url('/admin/resource/delete/') }}/"+id,
                            type: "GET",
                            dataType: "json",
                            success: function (data) {
                                if (data.success) {
